...
class MenuManager:
    ...
    def setup_menus(self):
        ...
        self.main_window.menu_action_json_edit_mode = mode_menu.addAction("Normal", self.main_window.mode_manager.set_edit_mode)
        self.main_window.menu_action_read_mode = mode_menu.addAction("Read", self.main_window.mode_manager.set_read_mode)
        self.main_window.menu_action_json_mode = mode_menu.addAction("JSON", self.main_window.mode_manager.set_json_mode)
