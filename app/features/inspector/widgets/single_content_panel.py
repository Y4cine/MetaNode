...
from app.features.inspector.widgets.content_metadata_panel import ContentMetadataPanel
from app.shared.core.content_filter_parser import ContentFilterParser, is_valid_filter
from app.features.inspector.widgets.content_editor_factory import create_content_editor
...
class SingleContentPanel(QWidget):
    ...
    def _set_content_editor(self, content_dict):
        ...
        try:
            if renderer == "Form":
                from app.features.inspector.widgets.form_renderer import FormRenderer
            ...
            #     from app.features.inspector.widgets.json_editor import JsonEditor
