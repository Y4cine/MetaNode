...
from app.features.inspector.widgets.node_metadata_panel import NodeMetadataPanel
from app.features.inspector.widgets.content_panel_stack import ContentPanelStack
...
class NodeEditorPanel(QWidget):
    ...
    from app.shared.core.undo_manager import UndoManager
