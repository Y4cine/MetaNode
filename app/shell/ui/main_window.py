...
from app.shell.ui.node_editor_panel import NodeEditorPanel
from app.shared.core.schema_registry import SchemaRegistry
from app.shared.utils.user_settings import get_recent_files
import os
from app.shell.ui.toolbar_manager import ToolbarManager
from app.shell.ui.menu_manager import MenuManager
from app.shell.ui.custom_splitter import CustomSplitter
from app.shared.core.keyboard_manager import KeyboardNavigationManager
...
class MainWindow(QMainWindow):
    ...
    def _init_panel_state_manager(self):
        from app.shell.ui.panel_state_manager import PanelStateManager
        self.panel_state_manager = PanelStateManager(self)

    def _init_splitter_manager(self):
        from app.shell.ui.splitter_manager import SplitterManager
    ...
    def __init__(self):
        ...
        try:
            from app.shared.utils.user_settings import get_setting
        ...
        from app.shell.ui.file_manager import FileManager
        self.file_manager = FileManager(self)

        # ModeManager initialisieren
        from app.shell.ui.mode_manager import ModeManager
        ...
        if open_last and recent:
            ...
            if os.path.exists(last_file):
                ...
                from app.shared.core.project_settings import get_settings, restore_layout_from_settings
    ...
    def load_stylesheet(self):
        ...
        from app.shared.utils.user_settings import set_setting
    ...
    def show_json_view(self):
        ...
        from app.shell.ui.json_editor_manager import show_json_view
        show_json_view(self)
    ...
    def try_leave_global_json_editor(self):
        # Delegated to JsonEditorManager
        from app.shell.ui.json_editor_manager import try_leave_global_json_editor
        return try_leave_global_json_editor(self)

    def on_node_selected(self, node_id):
        # Delegated to NodeSelectionManager
        from app.shell.ui.node_selection_manager import on_node_selected
    ...
    def do_combined_undo(self):
        ...
        from app.shell.ui.undo_manager_helper import do_combined_undo
        do_combined_undo(self)

    def do_combined_redo(self):
        # Delegated to UndoManagerHelper
        from app.shell.ui.undo_manager_helper import do_combined_redo
        do_combined_redo(self)

    def edit_user_settings(self):
        # Delegated to SettingsManager
        from app.shell.ui.settings_manager import edit_user_settings
        edit_user_settings(self)

    def equalize_single_content_panels(self):
        # Delegated to SettingsManager
        from app.shell.ui.settings_manager import equalize_single_content_panels
